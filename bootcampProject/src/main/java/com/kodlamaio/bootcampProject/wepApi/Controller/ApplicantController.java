...
public class ApplicantController {
	...
	@GetMapping("/{id}")
	public DataResult <GetApplicantResponses> getById(@PathVariable int id){
		return this.applicantServices.getById(id);
	}
	
	@GetMapping()
	public DataResult<List<GetAllApplicantResponses>> GetAll(){
		return this.applicantServices.GetAll();
	}
	
	@PostMapping()
	public DataResult<CreateApplicantResponse> Add(@RequestBody CreateApplicantRequest createApplicantRequest){
		return this.applicantServices.Add(createApplicantRequest);
	}
	
	@PutMapping
	public DataResult<UpdateApplicantResponse> Update (@RequestBody UpdateApplicantRequest updateApplicantRequest){
		return this.applicantServices.Update(updateApplicantRequest);
	}
	
	@DeleteMapping("/{id}")
	public Result delete(@PathVariable int id) {
		return this.applicantServices.delete(id);
	}
